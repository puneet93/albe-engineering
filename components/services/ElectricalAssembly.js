    ...
    return (
      <>
        <div className="service-card" onClick={() => setShow(true)}>
            <Image src="/assembly.png" srcSet="/assembly@2x.png" className="img-fluid" width="554" height="1028" alt="Picture" />
            <div className="service-card-overlay d-flex flex-column">
                <h5>Electrical <br />and Mechanical <br />Assembly</h5>
        ...
        <div className={`service-popup ${Show ? 'd-block' : 'd-none'}`}>
          ...
          <Row className="m-0 h-100">
            <Col md="4" className="service-popup-image h-100 p-0" style={{backgroundImage: 'url(/assembly.png)'}}></Col>
            <Col md="8" className="h-100 p-0">
                <div className="service-popup-content">
                    <h3 className="text-blue text-normal">Electrical and Mechanical Assembly</h3>
