    ...
    return (
      <>
        <div className="service-card" onClick={() => setShow(true)}>
            <Image src="/Software.png" srcSet="/Software@2x.png" className="img-fluid" width="554" height="1028" alt="Picture" />
            <div className="service-card-overlay d-flex flex-column">
                <h5>Software <br />Engineering</h5>
        ...
        <div className={`service-popup ${Show ? 'd-block' : 'd-none'}`}>
          ...
          <Row className="m-0 h-100">
            <Col md="4" className="service-popup-image h-100 p-0" style={{backgroundImage: 'url(/Software.png)'}}></Col>
            <Col md="8" className="h-100 p-0">
                <div className="service-popup-content">
                    <h3 className="text-blue text-normal">Software Engineering</h3>
